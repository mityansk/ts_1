import { LogRegDataType, ValidateResponseType } from "./user.types";

export default class UserValidator {
    static validateSignUp({ username, email, password, repeatPassword }: LogRegDataType): ValidateResponseType {
      if (
        !username ||
    ...
    static validateSignIn({ email, password }: LogRegDataType): ValidateResponseType {
